...
export default async function EngagementsPage() {
  ...
  const serializedEngagements = engagements.map(e => ({
    _id: e._id.toString(),
    postUrl: e.postUrl,
    ...(e.postUrn !== undefined && { postUrn: e.postUrn }),
    ...(e.postAuthor !== undefined && { postAuthor: e.postAuthor }),
    ...(e.postContent !== undefined && { postContent: e.postContent }),
    engagementType: e.engagementType,
    ...(e.aiGeneratedComment !== undefined && { aiGeneratedComment: e.aiGeneratedComment }),
    ...(e.userEditedComment !== undefined && { userEditedComment: e.userEditedComment }),
    status: e.status,
    ...(e.scheduledFor !== undefined && { scheduledFor: e.scheduledFor.toISOString() }),
    ...(e.engagedAt !== undefined && { engagedAt: e.engagedAt.toISOString() }),
  ...
  const serializedReplies = replies.map(r => ({
    _id: r._id.toString(),
    ...(r.postId !== undefined && { postId: r.postId.toString() }),
    linkedinPostUrn: r.linkedinPostUrn,
    commentUrn: r.commentUrn,
    commenterName: r.commenterName,
    ...(r.commenterProfileUrl !== undefined && { commenterProfileUrl: r.commenterProfileUrl }),
    commentText: r.commentText ?? '',
    ...(r.aiGeneratedReply !== undefined && { aiGeneratedReply: r.aiGeneratedReply }),
    ...(r.userEditedReply !== undefined && { userEditedReply: r.userEditedReply }),
    status: r.status,
    ...(r.repliedAt !== undefined && { repliedAt: r.repliedAt.toISOString() }),
